...
Переходим к анализу постов пабликов. Мы выгрузили последние ...... постов пабликов ["KudaGo: Москва"]() и ["KudaGo: Санкт-Петербург"](). Затем мы провели обработку, лемматизацию и анализ текстов постов:
